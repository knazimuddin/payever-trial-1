Feature: Transaction list for user
  Background:
  ...
  Scenario: Transactions have different currencies, total amount should be converted to the default currency
    ...
    And I use DB fixture "transactions/user-transactions-list-with-different-currencies"
    And I get file "features/fixtures/json/user-transaction-list/elastic-transactions-list.json" content and remember as "elasticTransactionsListJson"
    And I get file "features/fixtures/json/user-transaction-list/elastic-total-by-currencies.json" content and remember as "totalByCurrencies"
    And I get file "features/fixtures/json/user-transaction-list/elastic-statuses-response.json" content and remember as "statusesResponse"
    And I get file "features/fixtures/json/user-transaction-list/elastic-specific-statuses-response.json" content and remember as "specificStatusesResponse"
    And I get file "features/fixtures/json/user-transaction-list/transactions-list-response.json" content and remember as "transactionsListJson"
    ...
    And I mock Elasticsearch method "search" with:
      ...
      """
    When I send a GET request to "/api/user/list?orderBy=created_at&direction=desc&limit=20&query=&page=1"
  ...
  Scenario: Sending request with filter, should build valid filters for elasticsearch
    ...
    And I mock Elasticsearch method "search" with:
      ...
      """
    When I send a GET request to "/api/user/list?orderBy=total&direction=desc&limit=20&query=test%20query&page=1&currency=EUR&filters%5Bcurrency%5D%5B0%5D%5Bcondition%5D=is&filters%5Bcurrency%5D%5B0%5D%5Bvalue%5D=AFN&filters%5Btype%5D%5B0%5D%5Bcondition%5D=isNot&filters%5Btype%5D%5B0%5D%5Bvalue%5D=cash&filters%5Boriginal_id%5D%5B0%5D%5Bcondition%5D=startsWith&filters%5Boriginal_id%5D%5B0%5D%5Bvalue%5D%5B0%5D=asd&filters%5Breference%5D%5B0%5D%5Bcondition%5D=contains&filters%5Breference%5D%5B0%5D%5Bvalue%5D%5B0%5D=testContains&search=test%20query"
    Then print last response
    And the response status code should be 200
