...
class RunActionsSantanderSeFixture extends BaseFixture {
  ...
  private readonly businessPaymentOptionModel: Model<BusinessPaymentOptionModel> =
    this.application.get(getModelToken(BusinessPaymentOptionSchemaName));
  private readonly paymentFlowModel: Model<PaymentFlowModel> =
    this.application.get(getModelToken(PaymentFlowSchemaName));
